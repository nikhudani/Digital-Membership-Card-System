<div class="card mb-0 shadow-sm rounded-top-4" data-te-vcard-color>
    <div class="p-5 d-flex align-items-center justify-content-center vcard-head-color rounded-top-4">
        <img class="position-absolute rounded-circle shadow-sm" height="80" alt="logo" style="top: 14%;" data-te-vcard-image>
    </div>
    <div class="card-body">

        <div class="text-center py-4 text-color">
            <h5 class="mt-2 mb-4 font-size-16" data-te-vcard-customer></h5>
            <h4 data-te-vcard-header></h4>
            <dl class="row text-start mb-0 mt-3">
               <!-- <dt class="col-sm-2">
        ...
        <div class="col text-center">
            ...
            <button id="contact-share" class="btn btn-sm btn-outline-dark" data-te-share-link="">
...
<script>
    ...
    $(document).on('click', '#contact-share', function () {
        // Get the link to be shared
        var link = window.location.href;

        // Open the share dialog for social media
        if (navigator.share) {
            navigator.share({
                url: link
            }).then(() => {
            ...
            // Fallback if the browser does not support native sharing
